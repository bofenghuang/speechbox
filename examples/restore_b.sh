...
# output_file_path=/projects/bhuang/corpus/speech/nemo_manifests/facebook/multilingual_librispeech/french/train/train_facebook_multilingual_librispeech_manifest_normalized_pnc.json

# input_file_path=/projects/bhuang/corpus/speech/nemo_manifests/facebook/voxpopuli/fr/train/train_facebook_voxpopuli_manifest_normalized.json
# output_file_path=/projects/bhuang/corpus/speech/nemo_manifests/facebook/voxpopuli/fr/train/train_facebook_voxpopuli_manifest_normalized_pnc.json

# input_file_path=/projects/bhuang/corpus/speech/nemo_manifests/media_speech/FR/media_speech_manifest_normalized.json
# output_file_path=/projects/bhuang/corpus/speech/nemo_manifests/media_speech/FR/media_speech_manifest_normalized_pnc.json
...
# output_file_path=/projects/bhuang/corpus/speech/nemo_manifests/gigant/african_accented_french/train/train_gigant_african_accented_french_manifest_normalized_pnc.json

# input_file_path=/projects/bhuang/corpus/speech/nemo_manifests/att_hack/att_hack_manifest_normalized_min1_dedup256.json
# output_file_path=/projects/bhuang/corpus/speech/nemo_manifests/att_hack/att_hack_manifest_normalized_min1_dedup256_pnc.json
...
# output_file_path=/projects/bhuang/corpus/speech/nemo_manifests/PolyAI/minds14/fr-FR/train/train_PolyAI_minds14_manifest_normalized_pnc.json
...
# output_file_path=/projects/bhuang/corpus/speech/nemo_manifests/lingualibre/FR/lingualibre_manifest_normalized_min05_dedup4_pnc.json
